    ...
    $('#search_btn_last').click(function (){    
         ...
         // validate input date...
			...
			$.each(response, function (j, item){
             if(item.gender == "Male") {                                       
           // trHTML += '<tr><td>' + (j+1) + '</td><td>' + item.RegNo + '</td><td>'+ item.nic2 + '</td><td>' + item.address1 + " " + "  " + item.address2 +'</td><td>'+ item.gender + '</td><td>' + item.fname + " " + "  " + item.lname + '</td><td>' + item.participating + '</td></tr>' ; 
            trHTML += '<tr><td>' + item.RegNo + '</td><td>'+ item.nic2 + '</td><td>' + item.address1 + " " + "  " + item.address2 +'</td><td>'+ item.gender + '</td><td>' + item.fname + " " + "  " + item.lname + '</td><td>' + item.participating1 + '</td></tr>' ; 
} });                                                      
          ...
          //  trHTML2 += '<tr><td>' + (j+1) + '</td><td>' + item.RegNo + '</td><td>'+ item.nic2 + '</td><td>' + item.address1 + " " + "  " + item.address2 +'</td><td>'+ item.gender + '</td><td>' + item.fname + " " + "  " + item.lname + '</td><td>' + item.participating + '</td></tr>' ; 
            trHTML2 += '<tr><td>' + item.RegNo + '</td><td>'+ item.nic2 + '</td><td>' + item.address1 + " " + "  " + item.address2 +'</td><td>'+ item.gender + '</td><td>' + item.fname + " " + "  " + item.lname + '</td><td>' + item.participating1 + '</td></tr>' ; 
} });                                                      
...
<body>
<table id="records_table" width="1352" height="254" border="1">
    
    
  <tr>
    <td height="18" colspan="7">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="TopicFontSize">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Participation Report</span></td>
  </tr>
    
    
    
  <tr>
    <td height="109" colspan="7"><p><span class="colorx"><strong>Course Date  :&nbsp; </strong></span><strong>&nbsp; &nbsp; &nbsp; &nbsp; </strong><span>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img  id="search_btn_last" src="search-btn.png" width="190" height="40" alt="search" longdesc="search-btn.png" type="button" />&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<img id = "save_image" src="Save-icon.png" width="60" height="59" alt="save2" longdesc="../reports participation/Save-icon.png" />&nbsp;&nbsp;&nbsp;</p>
  ...
  <tr>
   <!-- <th width="80" height="27">&nbsp;</th>  -->
    <th width="196"><span class="DetailsLable">Registration_Number</span></th>
    <th width="149"><span class="DetailsLable">NIC</span></th>
    <th width="405"><span class="DetailsLable">Address</span></th>   
    <th width="95"><span class="DetailsLable"> Gender</span><span class="DetailsLable"></span></th>
    <th width="305"><span class="DetailsLable"> Name</span></th>
    <th width="162" height="27"><span class="Topic2">Participating</span></th>                  
  </tr>
...
&nbsp; No</span></label></td> -->     					
    ...
    <p>&nbsp;</p>
    <table id="records_table2" width="1353" height="39" border="1">
      
  <tr>
   <!-- <th width="80" height="27">&nbsp;</th>-->
    <th width="196"><span class="DetailsLable"> Registration_Number</span></th>
    <th width="149"><span class="DetailsLable">NIC</span></th>
    <th width="406"><span class="DetailsLable">Address</span></th>    
    <th width="95"><span class="DetailsLable">Gender</span><span class="DetailsLable"></span></th>
    <th width="305"><span class="DetailsLable"> Name</span></th>
    <th width="162" height="27"><span class="Topic2">Participating</span></th>                  
  </tr>
